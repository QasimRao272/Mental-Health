...
public class CustomizedActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] layouts = {R.layout.intro_screen5, R.layout.intro_screen1, R.layout.intro_screen2, R.layout.intro_screen3, R.layout.intro_screen4, R.layout.intro_screen6};
